...
(assert (let ((a!1 (or (= #xa2 args_0_8)
      ...
      (a!34 (or (= #xa2 args_3_8)
                (not (or (= #x4f args_3_8)
                         ...
                         (= #xfe args_3_8)
                         (= #x02 args_3_8)))))
      (a!67 (concat (concat #b111111111111111111111111111111111111111111111111111111111
                            (ite (= #x2f args_3_8) #b0 #b1))
                    #b11111))
      (a!68 (concat (concat #b000000000000000011111111111111111111111100000000000000001
                            (ite (= #x00 args_3_8) #b1 #b0))
                    #b11111))
      (a!71 (concat (concat (ite (= #x00 args_3_8) #b1 #b0) #b11111)
                    (ite (= #x00 args_0_8) #b1 #b0)))
      (a!73 (bvadd #b111111 (concat #b11111 (ite (= #x00 args_0_8) #b1 #b0))))
...
(let ((a!2 (or (= #xa1 args_0_8) (not (or (= #x5f args_0_8) (not a!1)))))
      ...
      (a!72 (bvnot (bvxor ((_ extract 6 6) (bvadd #b1111111 a!71))
                          (ite (= #x00 args_3_8) #b1 #b0)))))
...
(let ((a!4 (or (= #x9f args_0_8) (not (or (= #x61 args_0_8) (not a!3)))))
      ...
      (a!74 (concat (concat (concat a!70 ((_ extract 7 7) a!69)) a!72)
                    ((_ extract 5 1) a!73))))
