(declare-fun strlen_545_64 () (_ BitVec 64))
...
(assert (let ((a!1 (bvnot (bvor (bvnot (bvadd #xfefefeff mem_7fffffffffee5c0_140_32))
                        ...
                        #x7f7f7f7f))))
  (and (not (= #x00000000 a!1)) (= #x0000000000000000 strlen_545_64))))
(maximize (let ((a!1 (bvor (bvnot (bvadd #xfeff
      ...
      (a!2 (bvor (bvnot ((_ extract 23 16)
                 ...
                 ((_ extract 23 16) mem_7fffffffffee5c0_140_32)
                 #x7f))
      (a!3 (bvor (bvnot (bvadd #xff
                               ((_ extract 7 0) mem_7fffffffffee5c0_140_32)))
                 ((_ extract 7 0) mem_7fffffffffee5c0_140_32)
                 #x7f)))
...
(let ((a!5 (bvule (ite (= #x0000 (bvnot a!1)) (bvnot a!2) (bvnot a!3)) a!4)))
  (bvadd #xfffffffffffffffd
         (ite (= #x0000 (bvnot a!1)) #x07fffffffffee5c6 #x07fffffffffee5c4)
