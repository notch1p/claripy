...
(declare-fun strlen_646_64 () (_ BitVec 64))
...
(let ((a!2 (bvnot (bvor (bvnot (bvadd #xfefefeff a!1)) a!1 #x7f7f7f7f)))
  ...
  (and (= #x0000000000000000 strlen_646_64)
       (= #x00000000 a!2)
       (= #x00000000 a!4)
       (= #x00000000 a!6)
       (= #x00000000 a!8)
...
(define-fun goal () (_ BitVec 64) (let ((a!1 (bvor (bvnot (bvadd #xff
      ...
      (a!2 ((_ extract 15 8)
             (bvadd #xfeff
                    (concat ((_ extract 575 568) mem_7fffffffffee5d8_351_712)
                            ((_ extract 583 576) mem_7fffffffffee5d8_351_712)))))
      (a!5 (concat (concat (concat ((_ extract 559 552)
                                     mem_7fffffffffee5d8_351_712)
                                   ((_ extract 567 560)
                                     mem_7fffffffffee5d8_351_712))
                           ((_ extract 575 568) mem_7fffffffffee5d8_351_712))
...
(let ((a!3 (= #x00
      ...
      (a!6 (bvor (bvnot ((_ extract 23 16) (bvadd #xfefefeff a!5)))
                 ((_ extract 567 560) mem_7fffffffffee5d8_351_712)
                 #x7f)))
