...
(assert (let ((a!1 (bvule (ite (= #xffffffffffffffff strlen_68_64)
      ...
      (a!44 (concat (concat (concat ((_ extract 31 31) strlen_84_64)
                                    ((_ extract 31 31) strlen_84_64))
                            ((_ extract 31 31) strlen_84_64))
                    ((_ extract 31 31) strlen_84_64)))
      (a!55 (or (not (= #b1 ((_ extract 31 31) strlen_84_64)))
...
(let ((a!12 (ite (= #x00 ((_ extract 711 704) mem_c0012b42_74_1016))
                 ...
                 (ite (= #x00 ((_ extract 703 696) mem_c0012b42_74_1016))
                      #x00000000c0012b69
                      a!11)))
      (a!53 (concat (concat (concat a!52 ((_ extract 31 31) strlen_84_64))
                            ((_ extract 31 31) strlen_84_64))
                    ((_ extract 31 31) strlen_84_64))))
(let ((a!13 (ite (= #x00 ((_ extract 727 720) mem_c0012b42_74_1016))
      ...
      (a!54 (bvadd #x0000000000000003
                   (concat (concat a!53 ((_ extract 31 31) strlen_84_64))
