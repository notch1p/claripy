...
(let ((a!2 (bvnot (bvor (bvnot (bvadd #xfefefeff a!1)) a!1 #x7f7f7f7f)))
  ...
  (and (= #x00000000 a!2)
       ...
       (= #x00000000 a!26)
       (not (= #x00000000 a!28))
       (= #x0000000000000000 strlen_874_64)))))
(maximize (let ((a!1 (bvor (bvnot (bvadd #xff
      ...
      (a!2 ((_ extract 15 8)
             (bvadd #xfeff
                    (concat ((_ extract 319 312) mem_7fffffffffee5d4_316_744)
                            ((_ extract 327 320) mem_7fffffffffee5d4_316_744)))))
      (a!5 (concat (concat (concat ((_ extract 303 296)
                                     mem_7fffffffffee5d4_316_744)
                                   ((_ extract 311 304)
                                     mem_7fffffffffee5d4_316_744))
                           ((_ extract 319 312) mem_7fffffffffee5d4_316_744))
...
(let ((a!3 (= #x00
      ...
      (a!6 (bvor (bvnot ((_ extract 23 16) (bvadd #xfefefeff a!5)))
                 ((_ extract 311 304) mem_7fffffffffee5d4_316_744)
                 #x7f)))
