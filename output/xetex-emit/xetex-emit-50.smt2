(declare-fun mem_7fffffffffee5ec_188_32 () (_ BitVec 32))
(declare-fun strlen_213_64 () (_ BitVec 64))
(assert (let ((a!1 (bvnot (bvor (bvnot (bvadd #xfefefeff mem_7fffffffffee5ec_188_32))
                        mem_7fffffffffee5ec_188_32
                        #x7f7f7f7f))))
  (and (= #x0000000000000000 strlen_213_64) (not (= #x00000000 a!1)))))
(define-fun goal () (_ BitVec 64) (let ((a!1 (bvor (bvnot (bvadd #xfeff
      ...
      (a!2 (bvor (bvnot ((_ extract 23 16)
                          (bvadd #xfefefeff mem_7fffffffffee5ec_188_32)))
                 ((_ extract 23 16) mem_7fffffffffee5ec_188_32)
                 #x7f))
      (a!3 (bvor (bvnot (bvadd #xff
                               ((_ extract 7 0) mem_7fffffffffee5ec_188_32)))
                 ((_ extract 7 0) mem_7fffffffffee5ec_188_32)
                 #x7f)))
