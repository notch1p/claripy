...
(let ((a!2 (bvnot (bvor (bvnot (bvadd #xfefefeff a!1)) a!1 #x7f7f7f7f)))
  ...
  (and (= #x0000000000000000 strlen_769_64)
       (= #x00000000 a!2)
       (= #x00000000 a!4)
       (= #x00000000 a!6)
       (= #x00000000 a!8)
...
(maximize (let ((a!1 (bvor (bvnot (bvadd #xff
      ...
      (a!2 ((_ extract 15 8)
             (bvadd #xfeff
                    (concat ((_ extract 447 440) mem_7fffffffffee5d4_316_744)
                            ((_ extract 455 448) mem_7fffffffffee5d4_316_744)))))
      (a!5 (concat (concat (concat ((_ extract 431 424)
                                     mem_7fffffffffee5d4_316_744)
                                   ((_ extract 439 432)
                                     mem_7fffffffffee5d4_316_744))
                           ((_ extract 447 440) mem_7fffffffffee5d4_316_744))
...
(let ((a!3 (= #x00
      ...
      (a!6 (bvor (bvnot ((_ extract 23 16) (bvadd #xfefefeff a!5)))
                 ((_ extract 439 432) mem_7fffffffffee5d4_316_744)
                 #x7f)))
