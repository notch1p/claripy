...
(assert (let ((a!1 (concat (concat (concat ((_ extract 719 712)
...
(let ((a!2 (bvnot (bvor (bvnot (bvadd #xfefefeff a!1)) a!1 #x7f7f7f7f))))
  (and (not (= #x00000000 a!2)) (= #x0000000000000000 strlen_395_64)))))
(define-fun goal () (_ BitVec 64) (let ((a!1 (bvor (bvnot (bvadd #xff
      ...
      (a!2 ((_ extract 15 8)
             (bvadd #xfeff
                    (concat ((_ extract 735 728) mem_7fffffffffee5d4_316_744)
                            ((_ extract 743 736) mem_7fffffffffee5d4_316_744)))))
      (a!5 (concat (concat (concat ((_ extract 719 712)
                                     mem_7fffffffffee5d4_316_744)
                                   ((_ extract 727 720)
                                     mem_7fffffffffee5d4_316_744))
                           ((_ extract 735 728) mem_7fffffffffee5d4_316_744))
...
(let ((a!3 (= #x00
      ...
      (a!6 (bvor (bvnot ((_ extract 23 16) (bvadd #xfefefeff a!5)))
                 ((_ extract 727 720) mem_7fffffffffee5d4_316_744)
                 #x7f)))
