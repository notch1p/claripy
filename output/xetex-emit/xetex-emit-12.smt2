...
(let ((a!32 (ite (= #x00
  ...
  (and a!1
       ...
       (or a!43
           ...
           (= #x00 ((_ extract 543 536) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 551 544) mem_c0012b42_74_1016))
           ...
           (= #x00 ((_ extract 415 408) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 423 416) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 439 432) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 431 424) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 463 456) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 447 440) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 455 448) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 471 464) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 479 472) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 487 480) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 495 488) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 511 504) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 519 512) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 503 496) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 527 520) mem_c0012b42_74_1016))
           (= #x00 ((_ extract 535 528) mem_c0012b42_74_1016)))))))))))))))))))))))))))))))))))
(maximize (bvadd strlen_100_64 #x0000000000000001))
(check-sat)