(declare-fun strlen_902_64 () (_ BitVec 64))
...
(assert (let ((a!1 (concat (concat (concat ((_ extract 655 648)
      ...
      (a!21 (concat (concat (concat ((_ extract 367 360)
                                      mem_7fffffffffee5d8_351_712)
                                    ((_ extract 375 368)
                                      mem_7fffffffffee5d8_351_712))
                            ((_ extract 383 376) mem_7fffffffffee5d8_351_712))
                    ((_ extract 391 384) mem_7fffffffffee5d8_351_712)))
      (a!23 (concat (concat (concat ((_ extract 335 328)
                                      mem_7fffffffffee5d8_351_712)
                                    ((_ extract 343 336)
                                      mem_7fffffffffee5d8_351_712))
                            ((_ extract 351 344) mem_7fffffffffee5d8_351_712))
                    ((_ extract 359 352) mem_7fffffffffee5d8_351_712))))
(let ((a!2 (bvnot (bvor (bvnot (bvadd #xfefefeff a!1)) a!1 #x7f7f7f7f)))
  ...
  (and (= #x00000000 a!2)
       ...
       (= #x00000000 a!22)
       (not (= #x00000000 a!24))
       (= #x0000000000000000 strlen_902_64)))))
(maximize (let ((a!1 (bvor (bvnot (bvadd #xff
      ...
      (a!2 ((_ extract 15 8)
             (bvadd #xfeff
                    (concat ((_ extract 351 344) mem_7fffffffffee5d8_351_712)
                            ((_ extract 359 352) mem_7fffffffffee5d8_351_712)))))
      (a!5 (concat (concat (concat ((_ extract 335 328)
                                     mem_7fffffffffee5d8_351_712)
                                   ((_ extract 343 336)
                                     mem_7fffffffffee5d8_351_712))
                           ((_ extract 351 344) mem_7fffffffffee5d8_351_712))
...
(let ((a!3 (= #x00
      ...
      (a!6 (bvor (bvnot ((_ extract 23 16) (bvadd #xfefefeff a!5)))
                 ((_ extract 343 336) mem_7fffffffffee5d8_351_712)
                 #x7f)))
