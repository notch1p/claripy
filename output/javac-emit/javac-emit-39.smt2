...
(let ((a!194 (ite (= #x00
  ...
  (and (not (= #x2d args_3_8))
       ...
       (= (ite (= #x00 a!2) #x07fffffffffe6bbd #x07fffffffffe6bbe)
          (bvadd #x07fffffffffe6bb0 strlen_700_64))
       (= #x000000000000000
          ((_ extract 63 4) (bvadd #x0000000000000001 strlen_700_64)))
...
(define-fun goal () (_ BitVec 64) (bvadd strlen_700_64 #x0000000000000001)) 
(minimize goal)
(check-sat)