...
(declare-fun strlen_704_64 () (_ BitVec 64))
...
(let ((a!194 (ite (= #x00
  ...
  (and (= (ite (= #x00 args_0_8) #x07fffffffffeffd0 #x07fffffffffeffd1)
       ...
       (= (ite (= #x00 a!1) #x07fffffffffe6bbd #x07fffffffffe6bbe)
          (bvadd #x07fffffffffe6bb0 strlen_704_64))
       (= #x000000000000000
          ((_ extract 63 4) (bvadd #x0000000000000001 strlen_704_64)))
...
(define-fun goal () (_ BitVec 64) (bvadd strlen_704_64 #x0000000000000001)) 
(minimize goal)
(check-sat)