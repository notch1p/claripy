...
(let ((a!286 (concat (concat a!285
      ...
      (a!960 (ite (and (= #x00
                  ...
                  #x07fffffffffef201
                  a!959)))
(let ((a!961 (ite (and (= #x00
                          ((_ extract 1783 1776)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!896)
                  #x07fffffffffef200
                  a!960)))
(let ((a!962 (ite (or (= #x00
                         ((_ extract 1791 1784)
                           file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                      (not a!911))
                  #x07fffffffffef1ff
                  a!961)))
(let ((a!963 (ite (or (= #x00
                         ((_ extract 1799 1792)
                           file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                      (not a!873))
                  #x07fffffffffef1fe
                  a!962)))
(let ((a!964 (ite (or (= #x00
                         ((_ extract 1807 1800)
                           file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                      (not a!904))
                  #x07fffffffffef1fd
                  a!963)))
(let ((a!965 (ite (or (= #x00
                         ((_ extract 1815 1808)
                           file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                      (not a!891))
                  #x07fffffffffef1fc
                  a!964)))
(let ((a!966 (ite (and (= #x00
                          ((_ extract 1823 1816)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!880)
                  #x07fffffffffef1fb
                  a!965)))
(let ((a!967 (ite (and (= #x00
                          ((_ extract 1831 1824)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!884)
                  #x07fffffffffef1fa
                  a!966)))
(let ((a!968 (ite (and (= #x00
                          ((_ extract 1839 1832)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!929)
                  #x07fffffffffef1f9
                  a!967)))
(let ((a!969 (ite (and (= #x00
                          ((_ extract 1847 1840)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!913)
                  #x07fffffffffef1f8
                  a!968)))
(let ((a!970 (ite (or (= #x00
                         ((_ extract 1855 1848)
                           file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                      (not a!876))
                  #x07fffffffffef1f7
                  a!969)))
(let ((a!971 (ite (or (= #x00
                         ((_ extract 1863 1856)
                           file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                      (not a!921))
                  #x07fffffffffef1f6
                  a!970)))
(let ((a!972 (ite (or (= #x00
                         ((_ extract 1871 1864)
                           file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                      (not a!878))
                  #x07fffffffffef1f5
                  a!971)))
(let ((a!973 (ite (or (= #x00
                         ((_ extract 1879 1872)
                           file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                      (not a!905))
                  #x07fffffffffef1f4
                  a!972)))
(let ((a!974 (ite (and (= #x00
                          ((_ extract 1887 1880)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!872)
                  #x07fffffffffef1f3
                  a!973)))
(let ((a!975 (ite (and (= #x00
                          ((_ extract 1895 1888)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!917)
                  #x07fffffffffef1f2
                  a!974)))
(let ((a!976 (ite (and (= #x00
                          ((_ extract 1903 1896)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!887)
                  #x07fffffffffef1f1
                  a!975)))
(let ((a!977 (ite (and (= #x00
                          ((_ extract 1911 1904)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!915)
                  #x07fffffffffef1f0
                  a!976)))
(let ((a!978 (ite (and (= #x00
                          ((_ extract 1919 1912)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!906)
                  #x07fffffffffef1ef
                  a!977)))
(let ((a!979 (ite (and (= #x00
                          ((_ extract 1927 1920)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!892)
                  #x07fffffffffef1ee
                  a!978)))
(let ((a!980 (ite (and (= #x00
                          ((_ extract 1935 1928)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!922)
                  #x07fffffffffef1ed
                  a!979)))
(let ((a!981 (ite (and (= #x00
                          ((_ extract 1943 1936)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!918)
                  #x07fffffffffef1ec
                  a!980)))
(let ((a!982 (ite (and (= #x00
                          ((_ extract 1951 1944)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!893)
                  #x07fffffffffef1eb
                  a!981)))
(let ((a!983 (ite (and (= #x00
                          ((_ extract 1959 1952)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!874)
                  #x07fffffffffef1ea
                  a!982)))
(let ((a!984 (ite (and (= #x00
                          ((_ extract 1967 1960)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!900)
                  #x07fffffffffef1e9
                  a!983)))
(let ((a!985 (ite (and (= #x00
                          ((_ extract 1975 1968)
                            file_0_/etc/gcrypt/hwf.deny_0_227_2040))
                       a!916)
                  #x07fffffffffef1e8
...
(let ((a!992 (ite (= #x00
  ...
  (and a!2
       ...
       a!871
       a!932
       (= a!992 (bvadd #x07fffffffffef1e1 strlen_274_64))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
