(declare-fun filesize_file_9_/etc/gcrypt/fips_enabled_292_64 () (_ BitVec 64))
(declare-fun file_9_/etc/gcrypt/fips_enabled_0_332_2040 () (_ BitVec 2040))
(assert (let ((a!1 (or (bvsge #x0000000000000000
                      filesize_file_9_/etc/gcrypt/fips_enabled_292_64)
               (not (= #x00000000000000
                       ((_ extract 63 8)
                         filesize_file_9_/etc/gcrypt/fips_enabled_292_64)))))
...
(let ((a!2 (not (or (not (= #x0000000000000002
      ...
      (a!513 (or a!511
                 (not (= #x0a
                         ((_ extract 7 0)
                           file_9_/etc/gcrypt/fips_enabled_0_332_2040)))
                 a!512)))
(let ((a!4 (ite a!2
                (or (= #x0a
                       ((_ extract 2031 2024)
                         file_9_/etc/gcrypt/fips_enabled_0_332_2040))
                    (= a!3 filesize_file_9_/etc/gcrypt/fips_enabled_292_64))
                (not (= #x0a
                        ((_ extract 2031 2024)
                          file_9_/etc/gcrypt/fips_enabled_0_332_2040)))))
      (a!6 (ite a!5
                (or (= a!3 filesize_file_9_/etc/gcrypt/fips_enabled_292_64)
                    (= #x0a
                       ((_ extract 2039 2032)
                         file_9_/etc/gcrypt/fips_enabled_0_332_2040)))
                (not (= #x0a
