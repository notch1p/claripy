...
(assert (let ((a!1 (or (bvsge #x0000000000000000
      ...
      (a!304 (or (= #x00000000000000
                 ...
                 (bvsge #x0000000000000000
                        (bvadd #xffffffffffffff01
                               filesize_file_0_/etc/gcrypt/hwf.deny_220_64))))
      (a!305 (ite (bvsge #x0000000000000000
                         (bvadd #xffffffffffffff01
                                filesize_file_0_/etc/gcrypt/hwf.deny_220_64))
                  #x0000000000000000
                  (bvadd #xffffffffffffff01
      ...
      (a!813 (not (= #x00000000000000
                     ((_ extract 63 8)
                       (bvadd #xffffffffffffff01
                              filesize_file_0_/etc/gcrypt/hwf.deny_220_64)))))
      (a!815 (or (bvsge #x0000000000000000
                        (bvadd #xffffffffffffff01
                               filesize_file_0_/etc/gcrypt/hwf.deny_220_64))
                 (= #x00000000000000
                    ((_ extract 63 8)
...
(let ((a!3 (ite a!2
      ...
      (a!816 (ite (not a!814)
                  (or (= #x0a
                         ((_ extract 2039 2032)
                           file_0_/etc/gcrypt/hwf.deny_ff_303_2040))
                      (= (ite a!815 a!305 #x00000000000000ff)
                         (bvadd #xffffffffffffff01
                                filesize_file_0_/etc/gcrypt/hwf.deny_220_64)))
                  (not (= #x0a
                          ((_ extract 2039 2032)
                            file_0_/etc/gcrypt/hwf.deny_ff_303_2040)))))
      (a!818 (ite (not a!817)
                  (or (= (ite a!815 a!305 #x00000000000000ff)
                         (bvadd #xffffffffffffff01
                                filesize_file_0_/etc/gcrypt/hwf.deny_220_64))
                      (= #x0a
                         ((_ extract 2031 2024)
...
(let ((a!288 (= #x00000000
  ...
  (and a!3
       ...
       (bvule (ite a!304 a!305 #x00000000000000ff) #xf800000000010e1f)
       a!307
       a!309
       a!311
       a!313
