...
(assert (let ((a!1 (or (bvsge #x0000000000000000
      ...
      (a!973 (not (= #b00000
                     ((_ extract 63 59)
                       (bvadd #x07fffffffffef1df strlen_304_64)))))
      (a!974 (not (bvule (bvadd #b11111111111111111111111111111111111111111101111000111011111
...
(let ((a!407 (ite (= #x00
  ...
  (and a!3
       ...
       a!972
       (or a!973 a!974))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(maximize (bvadd #x07fffffffffef1df strlen_304_64))
(check-sat)