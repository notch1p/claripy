(declare-fun filesize_file_10_/etc/gcrypt/fips_enabled_294_64 () (_ BitVec 64))
(declare-fun file_10_/etc/gcrypt/fips_enabled_0_342_2040 () (_ BitVec 2040))
...
(let ((a!2 (not (or (not (= #x0000000000000002
      ...
      (a!513 (or a!511
                 (not (= #x0a
                         ((_ extract 7 0)
                           file_10_/etc/gcrypt/fips_enabled_0_342_2040)))
                 a!512)))
(let ((a!4 (ite a!2
                (or (= #x0a
                       ((_ extract 2031 2024)
                         file_10_/etc/gcrypt/fips_enabled_0_342_2040))
                    (= a!3 filesize_file_10_/etc/gcrypt/fips_enabled_294_64))
                (not (= #x0a
                        ((_ extract 2031 2024)
                          file_10_/etc/gcrypt/fips_enabled_0_342_2040)))))
      (a!6 (ite a!5
                (or (= a!3 filesize_file_10_/etc/gcrypt/fips_enabled_294_64)
                    (= #x0a
                       ((_ extract 2039 2032)
                         file_10_/etc/gcrypt/fips_enabled_0_342_2040)))
                (not (= #x0a
