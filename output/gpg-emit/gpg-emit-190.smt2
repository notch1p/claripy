...
(let ((a!632 (ite (= #x00
  ...
  (and a!258
       ...
       (bvule strlen_322_64 #xf800000000010e20)
       a!710
       a!711
       a!712
       a!713
       ...
       (or a!138 a!112)
       (or a!964 a!965)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(maximize (bvadd #x07fffffffffef1df strlen_322_64))
(check-sat)