...
(assert (let ((a!1 (or (not (= #x00000000000000
      ...
      (a!76 (and (= #x000000000000009a
                 ...
                 (or (= #x00000000000000
                     ...
                     (bvsge #x0000000000000000
                            filesize_file_4_/etc/gcrypt/hwf.deny_233_64))))
      (a!77 (not (or (= #x00000000000000
                        ((_ extract 63 8)
                          filesize_file_4_/etc/gcrypt/hwf.deny_233_64))
                     (bvsge #x0000000000000000
                            filesize_file_4_/etc/gcrypt/hwf.deny_233_64))))
      (a!78 (and (= #x0000000000000067
                    filesize_file_4_/etc/gcrypt/hwf.deny_233_64)
                 (not (bvsge #x0000000000000000
                             filesize_file_4_/etc/gcrypt/hwf.deny_233_64))
                 (or (= #x00000000000000
...
(let ((a!3 (ite a!2
      ...
      (a!885 (ite a!884
                  ...
                  (not (= #x0a
                          ((_ extract 15 8)
                            file_4_/etc/gcrypt/hwf.deny_0_253_2040)))))
      (a!887 (ite (not (or (or a!886 a!77)
                           a!884
                           a!882
                           a!880
                           a!878
