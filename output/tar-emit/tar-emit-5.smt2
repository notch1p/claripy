...
(let ((a!2 (concat (concat a!1 (ite (= #x2f args_2_8) #b0 #b1)) #b1))
      ...
      (a!23 (bvnot (bvxor ((_ extract 2 2) (bvadd #b111 a!22))
                          (ite (= #x00 args_1_8) #b1 #b0))))
      (a!30 (or (not (= #x2f args_1_8))
                (= ((_ extract 2 2) (bvadd #b111 a!22))
                   (ite (= #x00 args_1_8) #b1 #b0)))))
(let ((a!3 (concat (concat a!2 (ite (= #x2f args_1_8) #b0 #b1)) #b1))
      ...
      (a!19 (bvnot (bvxor ((_ extract 4 4) a!18)
                          (ite (= #x00 args_2_8) #b1 #b0))))
      (a!29 (or (not (= #x2f args_2_8))
                (= ((_ extract 4 4) a!18) (ite (= #x00 args_2_8) #b1 #b0)))))
(let ((a!7 (bvadd #xffffffffffffffff
                  (concat a!6 (ite (= #x00 args_0_8) #b1 #b0))))
      (a!12 (bvnot (bvxor ((_ extract 6 6) a!11)
                          (ite (= #x00 args_3_8) #b1 #b0))))
      (a!28 (or (not (= #x2f args_3_8))
                (= ((_ extract 6 6) a!11) (ite (= #x00 args_3_8) #b1 #b0))))
      (a!31 (ite a!29
                 (ite a!30
                      (ite (= #x2f args_0_8)
                           #x000000000000003f
...
(let ((a!8 (concat (concat (bvnot ((_ extract 63 48) a!7))
      ...
      (a!32 (bvsge #x0000000000000006
                   (bvadd #x0000000000000040
                          (bvmul #xffffffffffffffff
                                 (ite a!28 a!31 #x0000000000000039))))))
...
(let ((a!27 (bvor (concat a!3 (ite (= #x2f args_0_8) #b0 #b1))
  ...
  (and (not (= #x0000000000000000 (bvnot a!27)))
       a!32
       (not (= #x2d args_1_8))
       (= (ite (= #x00 args_1_8) #x07fffffffffeffd2 #x07fffffffffeffd3)
          (bvadd #x07fffffffffeffd2 strlen_177_64))))))))))))
(define-fun goal () (_ BitVec 64) (let ((a!1 (concat ((_ extract 31 31)
                     (bvadd #x00000004 ((_ extract 31 0) strlen_177_64)))
                   ((_ extract 31 31)
                     (bvadd #x00000004 ((_ extract 31 0) strlen_177_64))))))
(let ((a!2 (concat a!1
                   ((_ extract 31 31)
...
(let ((a!28 (concat a!27
                    ((_ extract 31 31)
                      (bvadd #x00000004 ((_ extract 31 0) strlen_177_64))))))
  (concat (concat a!28 (bvadd #x00000004 ((_ extract 31 0) strlen_177_64)))
          #b000)))))))))))))))))))))))))))))) 
(maximize goal)
(check-sat)