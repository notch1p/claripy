...
(let ((a!12 (concat (concat a!9 (bvnot ((_ extract 2 2) a!10)))
                    ((_ extract 1 1) a!11)))
      (a!20 (or (= #x16 args_1_8) (not (or (= #x2a args_1_8) (not a!19))))))
(let ((a!14 (bvor (concat a!1 (ite (= #x2f args_0_8) #b0 #b1))
                  (concat a!12 (bvnot a!13))))
      (a!21 (or (= #x17 args_1_8) (not (or (= #x29 args_1_8) (not a!20))))))
(let ((a!22 (or (not (or (= #x28 args_1_8) (not a!21)))
                (= #x27 args_1_8)
                (= #x19 args_1_8)
                (= #x18 args_1_8))))
(let ((a!23 (or (not (or (= #x26 args_1_8) (not a!22)))
                (= #x25 args_1_8)
                (= #x1a args_1_8)
                (= #x1b args_1_8))))
(let ((a!24 (or (not (or (= #x24 args_1_8) (not a!23)))
                (= #x1d args_1_8)
                (= #x1c args_1_8)
                (= #x23 args_1_8))))
(let ((a!25 (or (= #x1e args_1_8) (not (or (= #x22 args_1_8) (not a!24))))))
  (and (= #x0000000000000000 (bvnot a!14))
       (not (= #x2d args_1_8))
       (= #b00 ((_ extract 7 6) args_1_8))
       a!15
       (bvule #b0010000100 (concat args_1_8 #b00))
       (or (= #x21 args_1_8) (not a!25))))))))))))))
