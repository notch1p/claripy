...
(assert (let ((a!1 (concat (concat #b111111111111111111111111111111111111111111111111111111111
      ...
      (a!20 (bvxor (bvadd #b1 (ite (= #x00 args_0_8) #b1 #b0))
                   (ite (= #x00 args_0_8) #b1 #b0)))
      (a!26 (bvule (bvadd #b10000000110101010010100
                          (concat (concat #b0000000000000 args_1_8) #b00))
                   #b10000000110101110010000))
      (a!27 (not (or (not (= #x01 args_1_8)) (= #x3f args_1_8)))))
(let ((a!2 (concat (concat a!1 (ite (= #x2f args_2_8) #b0 #b1)) #b1))
      ...
      (a!24 (ite (or (not (= #x2f args_1_8)) (= #b0 ((_ extract 2 2) a!17)))
                 ...
                 #x000000000000003d))
      (a!28 (or (= #x3e args_1_8) (not (or (= #x02 args_1_8) a!27)))))
(let ((a!3 (concat (concat a!2 (ite (= #x2f args_1_8) #b0 #b1)) #b1))
      ...
      (a!29 (or (= #x3d args_1_8) (not (or (= #x03 args_1_8) (not a!28))))))
...
(let ((a!21 (bvor (concat a!3 (ite (= #x2f args_0_8) #b0 #b1))
      ...
      (a!33 (or (= #x32 args_1_8) (not (or (= #x0e args_1_8) (not a!32))))))
(let ((a!34 (or (= #x31 args_1_8) (not (or (= #x0f args_1_8) (not a!33))))))
(let ((a!35 (or (= #x30 args_1_8) (not (or (= #x10 args_1_8) (not a!34))))))
(let ((a!36 (or (= #x2f args_1_8) (not (or (= #x11 args_1_8) (not a!35))))))
(let ((a!37 (or (= #x2e args_1_8) (not (or (= #x12 args_1_8) (not a!36))))))
(let ((a!38 (or (= #x2c args_1_8) (not (or (= #x13 args_1_8) (not a!37))))))
(let ((a!39 (or (= #x2b args_1_8) (not (or (= #x14 args_1_8) (not a!38))))))
(let ((a!40 (or (= #x2a args_1_8) (not (or (= #x15 args_1_8) (not a!39))))))
(let ((a!41 (or (= #x29 args_1_8) (not (or (= #x16 args_1_8) (not a!40))))))
(let ((a!42 (or (= #x28 args_1_8) (not (or (= #x17 args_1_8) (not a!41))))))
(let ((a!43 (or (= #x27 args_1_8) (not (or (= #x18 args_1_8) (not a!42))))))
(let ((a!44 (or (= #x26 args_1_8) (not (or (= #x19 args_1_8) (not a!43))))))
(let ((a!45 (or (= #x25 args_1_8) (not (or (= #x1a args_1_8) (not a!44))))))
(let ((a!46 (or (= #x24 args_1_8) (not (or (= #x1b args_1_8) (not a!45))))))
(let ((a!47 (or (= #x23 args_1_8) (not (or (= #x1c args_1_8) (not a!46))))))
(let ((a!48 (or (= #x22 args_1_8) (not (or (= #x1d args_1_8) (not a!47))))))
(let ((a!49 (or (= #x21 args_1_8) (not (or (= #x1e args_1_8) (not a!48))))))
