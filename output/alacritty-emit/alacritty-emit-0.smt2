(declare-fun syscall_stub_sched_getaffinity_64_64 () (_ BitVec 64))
(assert (and (bvule ((_ extract 31 0) syscall_stub_sched_getaffinity_64_64) #xfffff000)))
(minimize (let ((a!1 (concat (concat (concat ((_ extract 31 31)
                                     syscall_stub_sched_getaffinity_64_64)
                                   ((_ extract 31 31)
                                     syscall_stub_sched_getaffinity_64_64))
                           ((_ extract 31 31)
                             syscall_stub_sched_getaffinity_64_64))
                   ((_ extract 31 31) syscall_stub_sched_getaffinity_64_64))))
