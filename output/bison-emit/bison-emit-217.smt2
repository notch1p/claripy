...
(declare-fun mem_c00afe73_482_16 () (_ BitVec 16))
(declare-fun mem_c00ab34b_394_16 () (_ BitVec 16))
...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!249 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00afe73_482_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
      ...
      (a!257 (or (not (= #x54 ((_ extract 1023 1016) mem_c009ea01_236_1032)))
...
(let ((a!113 (= (bvadd a!112
  ...
  (and (bvule a!2 mem_7fffffffffefab0_118_64)
       ...
       a!256
       a!257))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00afe73_482_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
