...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!249 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00afe73_495_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
      ...
      (a!257 (or (not (= #x2f ((_ extract 983 976) mem_c008fc14_402_1032)))
...
(let ((a!113 (= (bvadd a!112
  ...
  (and (not (= #x0000 mem_c00afe73_495_16))
       ...
       a!257))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00afe73_495_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
