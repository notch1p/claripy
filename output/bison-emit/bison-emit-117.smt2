...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!157 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00afe73_347_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
      ...
      (a!162 (not (bvule ((_ extract 15 0) mem_7fffffffffefab0_118_64)
                         (concat ((_ extract 935 928)
                                 ...
                                 ((_ extract 943 936)
                                   file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))
      (a!164 (or (not (= #x55 ((_ extract 1031 1024) mem_c0089d6f_215_1032)))
...
(let ((a!120 (= (bvadd a!119
  ...
  (and (not (= #x0000 mem_c00afe73_347_16))
       ...
       a!156
       (not (bvule a!11 mem_c00afe73_347_16))
       (bvule #x00000000c0080001 a!157)
       a!159
       a!161
       a!163
       ...
       a!164))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00afe73_347_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
