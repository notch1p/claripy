...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!134 (not (bvule ((_ extract 15 0) mem_7fffffffffefab0_118_64)
                         (concat ((_ extract 935 928)
                                 ...
                                 ((_ extract 943 936)
                                   file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))
      (a!136 (or (not (= #x2f ((_ extract 991 984) mem_c009f400_208_1032)))
...
(let ((a!113 (= (bvadd a!112
  ...
  (and (not (= #x0000 mem_c009d1d3_223_16))
       (= #x24
          ((_ extract 1023 1016)
            file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
       ...
       a!135
       a!136))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c009d1d3_223_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
