...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!242 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00add23_383_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
      ...
      (a!247 (not (bvule ((_ extract 15 0) mem_7fffffffffefab0_118_64)
                         (concat ((_ extract 935 928)
                                 ...
                                 ((_ extract 943 936)
                                   file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))
      (a!249 (or (not (= #x54 ((_ extract 1023 1016) mem_c0080200_326_1032)))
...
(let ((a!100 (bvadd a!99
  ...
  (and (not (= #x000000000000000 ((_ extract 63 4) mem_7fffffffffefab0_118_64)))
       ...
       a!241
       (not (= #x0000 mem_c00add23_383_16))
       (not (bvule a!108 mem_c00add23_383_16))
       ...
       a!249))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00add23_383_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
