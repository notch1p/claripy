...
(assert (let ((a!1 (bvmul #xffffffff
      ...
      (a!281 (bvadd #xc0080000
                    ...
                    (concat (concat #x0000
                            ...
                            ((_ extract 991 984)
                              file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))))
      (a!282 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00a6823_501_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
                              file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))))
      (a!283 (or (not (= #x55 ((_ extract 1031 1024) mem_c0089d6f_215_1032)))
      ...
      (a!284 (or (not (= #x55 ((_ extract 1031 1024) mem_c00800f2_262_1032)))
  ...
  (and (= #x24
       ...
       (or (= #x00
           ...
           (= #x00
              ((_ extract 687 680)
                file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))))))))))))))))))))))))))))))))))
(maximize (bvadd (concat #x000000000000 mem_c00a6823_501_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
