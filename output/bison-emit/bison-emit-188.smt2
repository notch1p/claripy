...
(declare-fun mem_c00a8c63_446_16 () (_ BitVec 16))
      ...
      (a!127 (ite (= #x00
                  ...
                  (bvadd #x00000000c0080002
                         ...
                         (concat #x00000000000000
                                 ((_ extract 991 984)
                                   file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))
      (a!129 (bvule #x00000000c0080003
                    (bvadd (concat #x00000000c008 mem_c009eae3_249_16)
                           (concat #x00000000000000
                                   ((_ extract 991 984)
                                     file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))
      (a!130 (bvule (bvadd (concat #xc008 mem_c009eae3_249_16)
                           (concat #x000000
                                   ((_ extract 991 984)
                                     file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))
                    #xc0080003))
      (a!131 (bvadd #x00000000c0080003
                    (bvmul #xffffffffffffffff
                           (concat #x00000000000000
                                   ((_ extract 991 984)
                                     file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))
      (a!132 (bvadd ((_ extract 31 0) mem_7fffffffffefab0_118_64)
                    (bvmul #xffffffff
                           (concat #x000000
                                   ((_ extract 991 984)
                                     file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))
      (a!133 (or (not (= #x0000000000000007 strlen_220_64))
                 (not (= #x46
                         ((_ extract 255 248)
                           file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))
                 (not (= #x2d
...
(let ((a!122 (bvadd a!121
  ...
  (and (bvule #x000000000004f443 mem_7fffffffffefab0_118_64)
       ...
       (= (concat #x000000000000 mem_c009eae3_249_16) a!126)
       (= #x00
          ((_ extract 983 976)
            file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
       (= #xe7
       ...
       a!129
       a!130
       (= (concat #x00000000c008 mem_c009eae3_249_16) a!131)
       (= #x0000 ((_ extract 31 16) a!132))
       (bvule a!125 mem_c00a3ba3_366_16)
       (not (bvule a!125 mem_c00a8c63_446_16))
       (or (= #x00
              ((_ extract 871 864)
                file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
           (= #x00
       ...
       (or (= #x00
           ...
           (= #x00
              ((_ extract 23 16)
                file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))
       a!133)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00a8c63_446_16)
