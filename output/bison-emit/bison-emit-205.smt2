...
(declare-fun mem_c00b2de3_467_16 () (_ BitVec 16))
(declare-fun mem_c00add23_381_16 () (_ BitVec 16))
...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!249 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00b2de3_467_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
      ...
      (a!254 (not (bvule ((_ extract 15 0) mem_7fffffffffefab0_118_64)
                         (concat ((_ extract 935 928)
                                 ...
                                 ((_ extract 943 936)
                                   file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))
      (a!256 (or (not (= #x55 ((_ extract 1031 1024) mem_c008a808_281_1032)))
...
(let ((a!80 (ite (= #x00
      ...
      (a!239 (bvadd #b000000000000000000000000000001
                    (ite a!229 (bvadd a!232 a!113) a!232)
                    ((_ extract 29 0)
                      (bvurem #x000000000a890b4f (concat #x00000000 a!102))))))
(let ((a!81 (ite (= #x00
                    ((_ extract 687 680)
...
(let ((a!82 (ite (= #x00
      ...
      (a!240 (bvadd (concat (concat #xc008
                            ...
                            ((_ extract 975 968)
                              file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                    (concat (ite a!236 (bvadd a!239 a!113) a!239) #b00)))
      (a!242 (bvadd #x00000001
                    (ite a!236 (bvadd a!235 a!105) a!235)
                    ((_ extract 31 0)
                      (bvurem #x000000000a890b4f (concat #x00000000 a!102)))))
      (a!246 (bvadd #b000000000000000000000000000001
                    (ite a!236 (bvadd a!239 a!113) a!239)
                    ((_ extract 29 0)
                      (bvurem #x000000000a890b4f (concat #x00000000 a!102))))))
(let ((a!83 (ite (= #x00
                    ((_ extract 719 712)
...
(let ((a!84 (ite (= #x00
      ...
      (a!247 (bvadd (concat (concat #xc008
                            ...
                            ((_ extract 975 968)
                              file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                    (concat (ite a!243 (bvadd a!246 a!113) a!246) #b00))))
(let ((a!85 (ite (= #x00
                    ((_ extract 751 744)
                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                 a!38
...
(let ((a!100 (bvadd a!99
  ...
  (and (not (= #x0000 mem_c00b2de3_467_16))
       (= #x24
          ((_ extract 1023 1016)
            file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
       ...
       a!256))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00b2de3_467_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
