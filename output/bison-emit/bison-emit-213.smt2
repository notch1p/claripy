...
(declare-fun mem_c00a6823_475_16 () (_ BitVec 16))
...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!327 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00a6823_475_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
      ...
      (a!336 (or (not (= #x2f ((_ extract 463 456) mem_c009ffc0_330_512)))
...
(let ((a!91 (ite (= #x00 ((_ extract 695 688) mem_c009f400_208_1032))
      ...
      (a!324 (bvadd #b000000000000000000000000000001
                    (ite a!314 (bvadd a!317 a!20) a!317)
                    ((_ extract 29 0)
                      (bvurem #x000000000a890b4f (concat #x00000000 a!12))))))
...
(let ((a!113 (= (bvadd a!112
  ...
  (and (= #x24
       ...
       a!319
       (bvule a!11 mem_c00a1cfb_389_16)
       (bvule #x00000000c00a6823 a!323)
       (= #x00000000 ((_ extract 63 32) a!323))
       (bvule a!325 #xc00a6823)
       a!326
       (not (= #x0000 mem_c00a6823_475_16))
       (not (bvule a!11 mem_c00a6823_475_16))
       (bvule #x00000000c008ffc3 a!327)
       ...
       a!336))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00a6823_475_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
