...
(declare-fun mem_c00b2de3_452_16 () (_ BitVec 16))
...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!249 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00b2de3_452_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
      ...
      (a!254 (not (bvule ((_ extract 15 0) mem_7fffffffffefab0_118_64)
                         (concat ((_ extract 935 928)
                                 ...
                                 ((_ extract 943 936)
                                   file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))
      (a!256 (or (not (= #x0000000000000007 strlen_220_64))
                 (not (= #x46
                         ((_ extract 255 248)
                           file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))
                 (not (= #x2d
...
(let ((a!82 (ite (= #x00
      ...
      (a!246 (bvadd #b000000000000000000000000000001
                    (ite a!236 (bvadd a!239 a!110) a!239)
                    ((_ extract 29 0)
                      (bvurem #x000000000a890b4f (concat #x00000000 a!102))))))
(let ((a!83 (ite (= #x00
                    ((_ extract 719 712)
...
(let ((a!84 (ite (= #x00
      ...
      (a!247 (bvadd (concat (concat #xc008
                            ...
                            ((_ extract 975 968)
                              file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                    (concat (ite a!243 (bvadd a!246 a!110) a!246) #b00))))
(let ((a!85 (ite (= #x00
                    ((_ extract 751 744)
                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                 a!38
...
(let ((a!100 (bvadd a!99
  ...
  (and (= #x24
       ...
       a!241
       (bvule a!210 mem_c00add23_370_16)
       (bvule #x00000000c00b2de3 a!245)
       (= #x00000000 ((_ extract 63 32) a!245))
       (bvule a!247 #xc00b2de3)
       a!248
       (not (= #x0000 mem_c00b2de3_452_16))
       (not (bvule a!210 mem_c00b2de3_452_16))
       ...
       (or (= #x00
           ...
           (= #x00
              ((_ extract 23 16)
                file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))
       a!256))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00b2de3_452_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
