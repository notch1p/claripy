...
(declare-fun mem_c00b94c3_515_16 () (_ BitVec 16))
...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!171 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00b94c3_515_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
      ...
      (a!176 (not (bvule ((_ extract 15 0) mem_7fffffffffefab0_118_64)
                         (concat ((_ extract 935 928)
                                 ...
                                 ((_ extract 943 936)
                                   file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))
      (a!178 (or (not (= #x55 ((_ extract 1031 1024) mem_c0089d6f_215_1032)))
...
(let ((a!120 (= (bvadd a!119
  ...
  (and (not (= #x0000 mem_c00986ab_205_16))
       ...
       a!163
       (bvule a!11 mem_c00b499b_414_16)
       (bvule #x00000000c00b94c3 a!167)
       (= #x00000000 ((_ extract 63 32) a!167))
       (bvule a!169 #xc00b94c3)
       a!170
       (not (= #x0000 mem_c00b94c3_515_16))
       (not (bvule a!11 mem_c00b94c3_515_16))
       ...
       a!178))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00b94c3_515_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
