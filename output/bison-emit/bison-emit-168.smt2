...
(let ((a!31 (= (bvadd a!30
  ...
  (and (bvule #x000000000004f92b mem_7fffffffffefab0_118_64)
       ...
       (= #xff
          ((_ extract 951 944)
            file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00ab34b_415_16)
