...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!242 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00ab34b_394_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
      ...
      (a!250 (or (not (= #x54 ((_ extract 1023 1016) mem_c009ea01_236_1032)))
...
(let ((a!113 (= (bvadd a!112
  ...
  (and (not (= #x0000 mem_c00ab34b_394_16))
       (= #x24
          ((_ extract 1023 1016)
            file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
       ...
       a!241
       (not (bvule a!11 mem_c00ab34b_394_16))
       (bvule #x00000000c008f403 a!242)
       ...
       a!249
       a!250))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00ab34b_394_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
