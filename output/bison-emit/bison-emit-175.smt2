...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!242 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00ab34b_422_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
      ...
      (a!247 (not (bvule ((_ extract 15 0) mem_7fffffffffefab0_118_64)
                         (concat ((_ extract 935 928)
                                 ...
                                 ((_ extract 943 936)
                                   file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))
      (a!249 (or (not (= #x55 ((_ extract 135 128) mem_c009ffef_243_136)))
...
(let ((a!2 (bvadd (concat (concat #x000000000000
      ...
      (a!248 (or (not (= #x000000000000
                         ((_ extract 63 16) mem_7fffffffffefab0_118_64)))
                 a!247))
      (a!250 (or (not (= #x2f ((_ extract 95 88) mem_c009ffef_243_136)))
                 ...
                 a!249))
      (a!251 (or (not (= #x0000000000000007 strlen_353_64))
...
(let ((a!134 (= (bvadd a!133
  ...
  (and (not (= #x0000 mem_c00ab34b_422_16))
       ...
       a!241
       (not (bvule a!11 mem_c00ab34b_422_16))
       ...
       a!250
       a!251))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00ab34b_422_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
