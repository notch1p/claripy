...
(declare-fun mem_c00bcf63_474_16 () (_ BitVec 16))
...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!171 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00bcf63_474_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
...
(let ((a!86 (ite (= #x00
      ...
      (a!168 (bvadd #b000000000000000000000000000001
                    (ite a!158 (bvadd a!161 a!113) a!161)
                    ((_ extract 29 0)
                      (bvurem #x000000000a890b4f (concat #x00000000 a!102))))))
(let ((a!87 (ite (= #x00
                    ((_ extract 783 776)
...
(let ((a!88 (ite (= #x00
      ...
      (a!166 (concat (concat #b000000000000000000000000000000
                             (ite a!165 (bvadd a!164 a!105) a!164))
                     #b00))
      (a!169 (bvadd (concat (concat #xc008
                            ...
                            ((_ extract 975 968)
                              file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                    (concat (ite a!165 (bvadd a!168 a!113) a!168) #b00))))
(let ((a!89 (ite (= #x00
                    ((_ extract 815 808)
                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                 a!30
      ...
      (a!170 (= (concat (concat #x00000000c008
                        ...
                        ((_ extract 975 968)
                          file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                (bvadd #x00000000c00bcf63 (bvmul #xffffffffffffffff a!166)))))
(let ((a!90 (ite (= #x00
                    ((_ extract 831 824)
                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                 a!28
...
(let ((a!100 (bvadd a!99
  ...
  (and (not (= #x000000000000000 ((_ extract 63 4) mem_7fffffffffefab0_118_64)))
       ...
       a!163
       (bvule a!108 mem_c00b7ea3_386_16)
       (bvule #x00000000c00bcf63 a!167)
       (= #x00000000 ((_ extract 63 32) a!167))
       (bvule a!169 #xc00bcf63)
       a!170
       (not (= #x0000 mem_c00bcf63_474_16))
       (not (bvule a!108 mem_c00bcf63_474_16))
       ...
       (or (= #x00
           ...
           (= #x00
              ((_ extract 951 944)
                file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024)))))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00bcf63_474_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
