...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!235 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00a6823_335_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
      ...
      (a!243 (or (not (= #x38 ((_ extract 999 992) mem_c009055f_258_1032)))
...
(let ((a!113 (= (bvadd a!112
  ...
  (and (bvule a!2 mem_7fffffffffefab0_118_64)
       ...
       a!242
       a!243))))))))))))))))))))))))))))))))))
(maximize (bvadd (concat #x000000000000 mem_c00a6823_335_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
