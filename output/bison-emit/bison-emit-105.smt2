...
(declare-fun mem_c00a6823_334_16 () (_ BitVec 16))
...
(assert (let ((a!1 (concat (concat (concat #b0000000000000000000000000000000000000000000000
      ...
      (a!235 (bvadd #x00000000c0080000
                    (concat #x000000000000 mem_c00a6823_334_16)
                    (concat (concat #x000000000000
                                    ((_ extract 983 976)
                                      file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
                            ((_ extract 991 984)
      ...
      (a!243 (or (not (= #x54 ((_ extract 1023 1016) mem_c009ea01_236_1032)))
...
(let ((a!113 (= (bvadd a!112
  ...
  (and (not (= #x0000 mem_c00a6823_334_16))
       ...
       a!227
       (bvule a!11 mem_c00a1cfb_285_16)
       (bvule #x00000000c00a6823 a!231)
       (= #x00000000 ((_ extract 63 32) a!231))
       (bvule a!233 #xc00a6823)
       a!234
       (not (bvule a!11 mem_c00a6823_334_16))
       (bvule #x00000000c008f403 a!235)
       ...
       a!242
       a!243))))))))))))))))))))))))))))))))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00a6823_334_16)
       (concat (concat #x000000000000
                       ((_ extract 983 976)
                         file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))
               ((_ extract 991 984)
