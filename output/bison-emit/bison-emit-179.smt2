(declare-fun file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024
             ()
             (_ BitVec 1024))
(declare-fun mem_c00b499b_432_16 () (_ BitVec 16))
...
(assert (let ((a!1 (bvadd ((_ extract 15 0) mem_7fffffffffefab0_118_64)
      ...
      (a!9 (bvule #x00000000c0080001
                  (bvadd #x00000000c0080000
                         (concat #x000000000000 mem_c00b499b_432_16)
                         (concat #x00000000000000
                                 ((_ extract 991 984)
                                   file_1_/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache_0_120_1024))))))
(let ((a!4 (bvadd a!3
  ...
  (and (not (= #x0000 mem_c00a6823_229_16))
       ...
       (bvule a!1 mem_c00afe73_356_16)
       (not (= #x0000 mem_c00b499b_432_16))
       (not (bvule a!1 mem_c00b499b_432_16))
       a!9))))
(define-fun goal () (_ BitVec 64) (bvadd (concat #x000000000000 mem_c00b499b_432_16)
