...
(assert (and (= (ite (= #x00 args_1_8) #x07fffffffffeffd2 #x07fffffffffeffd3)
        (bvadd #x07fffffffffeffd2 strlen_430_64))
     (= (ite (= #x00 args_2_8) #x07fffffffffeffd4 #x07fffffffffeffd5)
        (bvadd #x07fffffffffeffd4 strlen_478_64))
     (= (ite (= #x00 args_3_8) #x07fffffffffeffd6 #x07fffffffffeffd7)
        (bvadd #x07fffffffffeffd6 strlen_526_64))))
(maximize (let ((a!1 (concat ((_ extract 31 31)
                     (bvadd #x0000000d
                            ((_ extract 31 0) strlen_430_64)
                            ((_ extract 31 0) strlen_478_64)
                            ((_ extract 31 0) strlen_526_64)))
                   ((_ extract 31 31)
                     (bvadd #x0000000d
                            ((_ extract 31 0) strlen_430_64)
                            ((_ extract 31 0) strlen_478_64)
