...
(let ((a!2 (ite (or (= #x01 a!1) (not (= #x00 a!1))) #x00 args_1_8))
      (a!3 (ite (or (= #x01 a!1) (not (= #x00 a!1))) #x00 args_2_8))
      (a!4 (ite (or (= #x01 a!1) (not (= #x00 a!1))) #x00 args_3_8))
      (a!5 (= #x00 (ite (= #x01 a!1) #xc0 (ite (= #x00 a!1) #xae #x00))))
      (a!6 (= #x00 (ite (= #x01 a!1) #xae (ite (= #x00 a!1) #xc0 #x00))))
      (a!7 (ite (or (= #x01 a!1) (not (= #x00 a!1))) #x00 #xc0)))
(let ((a!8 (ite a!5
...
(let ((a!19 (bvadd (ite (= #x00 a!2)
  ...
  (and (not (= #x40 args_1_8))
       ...
       (not (= #x2d args_2_8))
       (not (= #x40 args_2_8))
       (= a!19 (bvadd #x07fffffffffeffd2 strlen_110_64))
       (or (not (= #x00 a!1)) (= #x01 a!1) (not (= #x5f args_1_8)))))))))))))))))))
(maximize (let ((a!1 (bvor (concat #b0000000 (ite (= #x2e args_1_8) #b1 #b0))
                 (concat #b0000000 (ite (= #x24 args_1_8) #b1 #b0)))))
  (bvadd #x07fffffffffeffd2 (concat #x00000000000000 a!1))))
(check-sat)